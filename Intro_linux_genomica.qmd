...
En la carpeta X se encuentra un archivo vcf con 10 mil variantes genéticas del cromosoma 21. El archivo original fue descargado del repositorio del proyecto 1000 genomas, de este se tomaron 10K variantes genéticas aleatoriamente.
...
La data original se descargo siguiendo los pasos descritos en el script (github de Alex)

Originalmente se decarga como VCF, pero debido a que es un archivo demasiado grande se convierte a formato bed, este ya no tiene información de depth o quality

Revisando el archivo VCF

algunas estadísticas del archivo de variantes

Data faltante, covertura, frecuencia alélica, etc

Esta data ya pasó control de calidad, por lo cual no es necesario pasar por esos pasos.

-   Data faltante, Cobertura, minor allele frequency

Un analisis inicial que podemos hacer es un PCA
